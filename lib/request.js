...
class JMRequest {
    constructor(method, url, options) {
        this._method = MethodNameMap[method];
        this._url = url;
        this.options = {};
        ...
        if (this.options.data && this.options.headers.contentType === 'application/json') {
            this.options.data = JMRequest.toJsonData(options.data);
        }
        if (this.options.data && this.options.headers.contentType === 'application/x-www-form-urlencoded') {
            this.options.data = JMRequest.toFormData(options.data);
        }
    }
